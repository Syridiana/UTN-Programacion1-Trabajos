...
/** \brief Crea una nueva LinkedList copiando una parte de la LinkedList original segun id de empleados
 *
 * \param Puntero a LinkedList original
 * \param Devuelve un puntero a LinkedList de la nueva lista. Sino pudo realizar la operacion retorna NULL.
 *
 */
