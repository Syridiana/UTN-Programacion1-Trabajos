...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this!=NULL && nodeIndex>=0 && nodeIndex<=ll_len(this) )
    {
        ...
        if(nuevoNodo!=NULL)
        {
            ...
            {
                Node* anteriorNodo=getNode(this, (nodeIndex-1));
...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this!=NULL && index>=0 && index<ll_len(this))
    {
        ...
        if(index==0 && nodoActual!=NULL) //Si es el primer nodo, ya sea el unico o no
        {
...
int ll_indexOf(LinkedList* this, void* pElement)
{
    ...
    if(this!=NULL)
    {
        ...
        while(i<tamanio)
        {
            ...
            if(pElement == auxNodo->pElement && auxNodo!=NULL)
            {
                returnAux=i;
            }
            i++;
...
int ll_contains(LinkedList* this, void* pElement)
{
    ...
    if(this!=NULL)
    {
        int indice = ll_indexOf(this, pElement);
        if(indice>=0)
        {
            returnAux=1;
        }
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this!=NULL && from>=0 && from<=ll_len(this) && to>from && to<=ll_len(this))
    {
        ...
        if(cloneArray!=NULL)
        {
            ...
            while(from<to)
            {
                Node* nodoACopiar = getNode(this, from);
                if(nodoACopiar!=NULL)
                {
                    ll_add(cloneArray, nodoACopiar->pElement);
                }
                from++;
            }
...
int ll_sort(LinkedList* this, int (*pFunc)(void*,void*), int order)
{
    ...
    if(this!=NULL && pFunc!=NULL&& (order==1 || order==0))
    {
        ...
        for(i=0; i<tam-1; i++)
        {
            for(j=i+1; j<tam; j++)
            {
                Node* nodoUno = getNode(this, i);
                Node* nodoDos = getNode(this, j);


                if(nodoDos !=NULL && nodoUno!=NULL )
                {

                        if((pFunc(ll_get(this, i), ll_get(this, j)))==1 && order == 1)
                        {
                            elementoAux = ll_get(this, i);
                            nodoUno->pElement = ll_pop(this, j);
                            ll_push(this, j, elementoAux);
                        }
                    else
